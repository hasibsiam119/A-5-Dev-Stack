...
export const Footer = () => {
    ...
    return (
        <>
        <div className="grid grid-cols-4 container mx-auto  gap-10 py-7 text-gray-500">
            <div className="">
                <img src={logo} alt="" />
...
modern software.</p>
        ...
        <div className="flex justify-between container mx-auto items-center text-gray-500 my-5" >
